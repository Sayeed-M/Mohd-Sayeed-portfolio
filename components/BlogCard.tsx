     ...
     <Link href={`#`} className="block h-full cursor-pointer group">
       ...
       >
           <MouseGlowBorder className="h-full">
               <GlassmorphismPanel className="flex flex-col h-full bg-white/40 border-white/50 backdrop-blur-xl p-8 relative overflow-hidden transition-all duration-500 shadow-sm group-hover:shadow-[0_20px_40px_rgba(0,0,0,0.06)] group-hover:bg-white/60">
                   ...
                   <div className="flex items-center justify-between mb-4 relative z-10">
                       <span className="px-3 py-1 rounded-md bg-slate-100/80 text-primary text-[11px] font-bold uppercase tracking-widest font-manrope border border-slate-200/50">
                           {data.category}
                       </span>
                       <span className="text-xs font-manrope font-semibold text-slate-400">
                   ...
                   <div className="flex flex-col flex-grow relative z-10">
                       <h3 className="font-display text-2xl font-bold text-slate-800 mb-3 tracking-tight group-hover:text-primary transition-colors">
                           {data.title}
                       </h3>
                       <p className="font-manrope text-sm text-slate-500 flex-grow mb-8 line-clamp-3 leading-relaxed">
                           {data.excerpt}
                       </p>
